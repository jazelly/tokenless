...
test('direct mode release documentation remains without a pending release changeset', () => {
  ...
  assert.equal(fs.existsSync(path.join(root, '.changeset/direct-mode-and-broker.md')), false)
})

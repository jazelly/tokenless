...
| Create Image / AI Creation | `image.generation`, `artifact.download` | Experimental routeable image surface; built CLI and packaged daemon completed one visible submission, terminal image artifact, local digest, and authenticated readback |

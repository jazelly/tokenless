...
| `image.generation` | Experimental | — | — | Experimental | — | — | — | — | — | — | — | Experimental | Experimental |
| `image.edit` | — | — | — | — | — | — | — | — | — | — | — | Experimental | — |
| `artifact.download` | Experimental | — | — | Experimental | — | — | — | — | — | — | — | Experimental | Experimental |
...
The G4F direct `images/generations` route now closes its own downloaded-asset boundary. A request supplies `tokenless.taskId` and `tokenless.conversationId`; Tokenless strips that local context before the upstream call, reads the returned private media bytes, verifies JPEG/PNG dimensions, persists a `0600` asset, and returns a relative authenticated `/v1/asset/...` URL plus common artifact metadata. The real `PollinationsImage` / `sana` gate generated and read back one 768×768 JPEG. This direct endpoint is separate from the browser-provider capability table above.

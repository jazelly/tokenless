...
| [Windows Cloak Setup Acceptance Test Plan](P0-windows-cloak-setup-acceptance-test-plan.md) | Execute and record the clean Windows Intel/AMD Anti-Detect setup matrix for Chrome, Brave, and Arc 145/150 profiles, exact Cloak 146 alignment, verified installation, isolation, and recovery paths. | P0 |

...
| [Windows AMD64 Cloak Setup Acceptance Test Plan](P0-windows-amd64-cloak-setup-acceptance-test-plan.md) | Execute and record the clean Windows AMD x86-64 Anti-Detect setup matrix for supported Chromium profiles, exact Cloak 146 alignment, verified installation, isolation, and recovery paths. | P0 |

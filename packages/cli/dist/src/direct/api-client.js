...
function validateChatGptRequest(request) {
...
function extractOpenAiResponseText(raw, requestId) {
...
function invalidResponseError(message, requestId) {
    return new DirectError('direct_invalid_response', message, {
        retryable: false,
        ...(requestId === undefined ? {} : { requestId }),
    });
}
function normalizeRequestId(value, apiKey) {

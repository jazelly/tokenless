...
import { INVALID_NONNEGATIVE_INTEGER, isRecord, optionalNonnegativeInteger, } from '../request-validation.js';
export function openAiResponsesBody(request, model) {
    return {
        model,
...
export function extractOpenAiResponseText(raw, requestId) {
...
export function openAiBodyRequestId(raw, apiKey) {

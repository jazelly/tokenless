...
export function geminiGenerateContentBody(request) {
...
export function extractGeminiCandidateText(raw, requestId) {
...
export function normalizeGeminiUsage(value) {
    if (!isRecord(value))
        return undefined;
    ...
    const outputTokens = candidateTokens === INVALID_NONNEGATIVE_INTEGER || thoughtTokens === INVALID_NONNEGATIVE_INTEGER
        ? undefined
...
//# sourceMappingURL=gemini-content.js.map
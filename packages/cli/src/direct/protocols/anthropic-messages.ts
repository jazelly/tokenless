...
export function anthropicMessagesBody(request: DirectRunRequest, model: string) {
  return {
    model,
...
export function extractAnthropicMessageText(raw: Record<string, unknown>, requestId: string | undefined) {
...
export function normalizeAnthropicUsage(value: unknown): DirectUsage | undefined {

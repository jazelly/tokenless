...
export const VISIBLE_ACTION_PROTOCOL_VERSION_V3 = "tokenless.playwright.visible-action.v3" as const
export const VISIBLE_ATTACHMENT_PROTOCOL_VERSION = "tokenless.visible-attachment.v1" as const
export const MANAGED_PLAYWRIGHT_JOB_PROTOCOL_VERSION = MANAGED_PLAYWRIGHT_JOB_PROTOCOL_VERSION_V3
export const RUNNER_CHECKPOINT_PROTOCOL = RUNNER_CHECKPOINT_PROTOCOL_V2
export const VISIBLE_ACTION_PROTOCOL_VERSION = VISIBLE_ACTION_PROTOCOL_VERSION_V3

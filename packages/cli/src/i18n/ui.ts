...
const enMessages = {
    ...
    providerConfiguration: 'Provider configuration', providersLede: 'Intent, observed access, evidence, and routing eligibility stay separate.', selectProfile: 'Profile', executionMode: 'Execution mode', browserMode: 'Browser', directMode: 'Direct', directOnlyProvider: 'Direct execution only',
    ...
    setup: 'Setup', setupTitle: 'Set up Tokenless', setupBody: 'Choose a Google Chrome or Brave Browser that you provide.', nativeChromeConnectionHelp: 'Tokenless does not bundle or download Chrome or Brave. If automatic discovery fails, setup still finishes and browser features remain unavailable until you add an executable path. Enable Remote Debugging before the first browser action. Only explicit Anti-Detect setup downloads CloakBrowser.', googleChrome: 'My Google Chrome', braveBrowser: 'My Brave Browser', continue: 'Continue', finishSetup: 'Finish setup', back: 'Back',
...
const zhMessages: Record<keyof typeof enMessages, string> = {
    ...
    providerConfiguration: 'Provider 配置', providersLede: '用户意图、实际观测、证据和路由资格分别展示，不混成一个状态。', selectProfile: 'Profile', executionMode: '执行模式', browserMode: '浏览器', directMode: 'Direct', directOnlyProvider: '仅支持 Direct',
    ...
    setup: '设置', setupTitle: '设置 Tokenless', setupBody: '选择由你提供的 Google Chrome 或 Brave Browser。', nativeChromeConnectionHelp: 'Tokenless 不会 bundle 或下载 Chrome/Brave。自动发现失败时 setup 仍会完成；在添加 executable path 前，browser 功能不可用。首次 browser action 前请启用 Remote Debugging。只有显式选择 Anti-Detect setup 才会下载 CloakBrowser。', googleChrome: '我的 Google Chrome', braveBrowser: '我的 Brave Browser', continue: '继续', finishSetup: '完成设置', back: '返回',

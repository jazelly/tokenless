...
const enMessages = {
    ...
    setup: 'Setup', setupTitle: 'Set up Tokenless', setupBody: 'Connect to your running Google Chrome 144+ in headed native mode.', nativeChromeConnectionHelp: 'Enable Remote Debugging in Chrome. Chrome manages the CDP endpoint; no fixed port is configured.', continue: 'Continue', finishSetup: 'Finish setup', back: 'Back',
...
const zhMessages: Record<keyof typeof enMessages, string> = {
    ...
    setup: '设置', setupTitle: '设置 Tokenless', setupBody: '以 headed native mode 连接正在运行的 Google Chrome 144+。', nativeChromeConnectionHelp: '请在 Chrome 中启用 Remote Debugging；CDP endpoint 由 Chrome 管理，无需配置固定端口。', continue: '继续', finishSetup: '完成设置', back: '返回',

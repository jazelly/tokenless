...
const enMessages = {
    ...
    setup: 'Setup', setupTitle: 'Set up Tokenless', setupBody: 'Connect to your running Google Chrome or Brave Browser in headed native mode.', nativeChromeConnectionHelp: 'Enable Remote Debugging in the selected browser. The browser manages the CDP endpoint; no fixed port is configured.', googleChrome: 'Google Chrome', braveBrowser: 'Brave Browser', continue: 'Continue', finishSetup: 'Finish setup', back: 'Back',
...
const zhMessages: Record<keyof typeof enMessages, string> = {
    ...
    setup: '设置', setupTitle: '设置 Tokenless', setupBody: '以 headed native mode 连接正在运行的 Google Chrome 或 Brave Browser。', nativeChromeConnectionHelp: '请在所选浏览器中启用 Remote Debugging；CDP endpoint 由浏览器管理，无需配置固定端口。', googleChrome: 'Google Chrome', braveBrowser: 'Brave Browser', continue: '继续', finishSetup: '完成设置', back: '返回',

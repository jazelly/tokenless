...
const messages = {
  en: {
    ...
    setup: 'Setup', setupTitle: 'Set up Tokenless', setupBody: 'Connect to your running Google Chrome 144+ in headed native mode.', continue: 'Continue', finishSetup: 'Finish setup', back: 'Back',
  ...
  'zh-CN': {
    ...
    setup: '设置', setupTitle: '设置 Tokenless', setupBody: '以 headed native mode 连接正在运行的 Google Chrome 144+。', continue: '继续', finishSetup: '完成设置', back: '返回',

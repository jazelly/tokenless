...
const messages = {
  en: {
    ...
    cleanProfileNote: 'Profiles start clean by default. Experimental opaque import from Google Chrome 145 or Brave Chromium 143/145 is available on macOS for managed Chrome for Testing 145 and CloakBrowser 145.',
    ...
    setup: 'Setup', setupTitle: 'Set up Tokenless', setupBody: 'Use the platform-pinned managed Chrome for Testing, or explicitly choose CloakBrowser.', continue: 'Continue', finishSetup: 'Finish setup', back: 'Back',
    ...
    profileStart: 'Start from', cleanProfile: 'Clean profile', cleanProfileHelp: 'Sign in in a new isolated browser.', copyProfile: 'Copy existing profile', copyProfileHelp: 'Copy one eligible Google Chrome or Brave profile as an opaque tree.', copyChromeProfileExperimental: 'Copy browser profile (experimental)', copyChromeProfileExperimentalHelp: 'Try an opaque copy from an eligible Google Chrome or Brave version.',
    profileImportExperimentalHelp: 'Experimental on Apple Silicon macOS: Google Chrome major 145 and Brave Chromium major 143 or 145 can target managed Chrome for Testing 145 or CloakBrowser 145. Edge, Chromium, Chrome for Testing, Arc, other versions, and Windows sources are not eligible. A successful open does not guarantee sign-in transfer.',
    browserProfiles: 'Local Google Chrome or Brave profiles', profileScanPrivacy: 'Only names and versions are shown here.', scanProfiles: 'Scan', scanAgain: 'Scan again', sourceProfile: 'Source profile', sourceBrowser: 'Source browser', profileRootPath: 'Profile root', chromeProfileRootPath: 'Source browser profile root', profileRootPathPlaceholder: '/absolute/path/to/user-data…', customProfileRoot: 'Custom profile root', scanProfilesHelp: 'Choose Google Chrome or Brave, then scan for an eligible profile.', incompatible: 'Incompatible',
  ...
  'zh-CN': {
    ...
    cleanProfileNote: 'Profile 默认从 clean 状态开始。在 macOS 上，可实验性地把 Google Chrome 145 或 Brave Chromium 143/145 opaque 导入 managed Chrome for Testing 145 或 CloakBrowser 145。',
    ...
    setup: '设置', setupTitle: '设置 Tokenless', setupBody: '使用按平台固定版本的 managed Chrome for Testing，或明确选择 CloakBrowser。', continue: '继续', finishSetup: '完成设置', back: '返回',
    ...
    profileStart: 'Profile 起点', cleanProfile: '全新 profile', cleanProfileHelp: '在新的隔离浏览器中登录。', copyProfile: '复制现有 profile', copyProfileHelp: '把一个符合条件的 Google Chrome 或 Brave profile 作为 opaque 文件树复制。', copyChromeProfileExperimental: '复制浏览器 profile（实验性）', copyChromeProfileExperimentalHelp: '尝试从符合条件的 Google Chrome 或 Brave 版本进行 opaque 复制。',
    profileImportExperimentalHelp: 'Apple Silicon macOS 实验性支持：Google Chrome major 145，以及 Brave Chromium major 143 或 145，可以导入 managed Chrome for Testing 145 或 CloakBrowser 145。Edge、Chromium、Chrome for Testing、Arc、其他版本和 Windows 来源均不可导入。成功打开也不保证登录状态能迁移。',
    browserProfiles: '本地 Google Chrome 或 Brave profile', profileScanPrivacy: '这里只显示名称和版本。', scanProfiles: '扫描', scanAgain: '重新扫描', sourceProfile: '来源 profile', sourceBrowser: '来源浏览器', profileRootPath: 'Profile 根目录', chromeProfileRootPath: '来源浏览器 profile 根目录', profileRootPathPlaceholder: '/用户数据目录的绝对路径…', customProfileRoot: '自定义 profile 根目录', scanProfilesHelp: '先选择 Google Chrome 或 Brave，再扫描符合条件的 profile。', incompatible: '不兼容',
...
const uiErrorZh: Record<string, string> = {
  ...
  profile_import_browser_unsupported: '实验性 profile 导入仅支持 Google Chrome 和符合条件的 Brave profile。',
  profile_import_runtime_unsupported: '实验性 profile 导入需要使用 Tokenless-managed Chrome for Testing 或 CloakBrowser。',
  browser_profile_version_incompatible: '这个来源浏览器 profile 与当前 managed browser runtime 不兼容。',

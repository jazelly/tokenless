...
const messages = {
  en: {
    ...
    profileStart: 'Start from', cleanProfile: 'Clean profile', cleanProfileHelp: 'Sign in in a new isolated browser.', copyProfile: 'Copy existing profile', copyProfileHelp: 'Copy one local Chromium profile as an opaque tree.', copyChromeProfileExperimental: 'Copy Google Chrome profile (experimental)', copyChromeProfileExperimentalHelp: 'Try an opaque copy from Google Chrome; some versions or platforms may not work.',
  ...
  'zh-CN': {
    ...
    profileStart: 'Profile 起点', cleanProfile: '全新 profile', cleanProfileHelp: '在新的隔离浏览器中登录。', copyProfile: '复制现有 profile', copyProfileHelp: '把一个本地 Chromium profile 作为 opaque 文件树复制。', copyChromeProfileExperimental: '复制 Google Chrome profile（实验性）', copyChromeProfileExperimentalHelp: '尝试从 Google Chrome 进行 opaque 复制；部分版本或平台可能无法使用。',

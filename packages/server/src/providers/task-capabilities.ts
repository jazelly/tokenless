...
const TASK_CAPABILITY_CATALOG = Object.freeze([
  defineCapability({
    ...
    requiredEvidence: ['visible_submission', 'correlated_visible_response', 'stored_job_result'],
    outputKinds: ['text'],
    stability: 'supported',
  }),
  defineCapability({
  ...
  inputCapability(TASK_CAPABILITIES.DOCUMENT_INPUT, 'Document input', 'Deliver a document as provider input.'),
  ...
  defineCapability({
    ...
    requiredEvidence: ['research_plan', 'terminal_report', 'visible_citations', 'visible_background_progress'],
  ...
  defineCapability({
    ...
    description: 'Allow a long-running provider task to continue without keeping the page foregrounded.',
    family: 'evidence_lifecycle',
    lifecycle: 'long_running',
    sideEffects: ['persist_provider_state'],
    requiredEvidence: ['visible_background_progress', 'terminal_state'],
    outputKinds: [],
  }),
  defineCapability({
    id: TASK_CAPABILITIES.TASK_INTERACTIVE,
    title: 'Interactive task',
    description: 'Surface provider clarification or confirmation during the current execution.',
    family: 'evidence_lifecycle',
    lifecycle: 'interactive',
    sideEffects: ['persist_provider_state'],
    requiredEvidence: ['waiting_for_user', 'current_execution_continuation'],
    outputKinds: [],
  }),
  defineCapability({
...
const PROVIDER_TASK_CAPABILITY_ROUTES = Object.freeze([
  ...
  route('chatgpt', TASK_CAPABILITIES.DOCUMENT_INPUT, 'supported', 'visible-document-attachment', ['harness-attachment-roundtrip']),
  route('claude', TASK_CAPABILITIES.CONVERSATION_CHAT, 'supported', 'visible-conversation', ['conversation-workflow']),
  route('claude', TASK_CAPABILITIES.FILE_UPLOAD, 'supported', 'visible-file-attachment', ['file-selection']),
  route('claude', TASK_CAPABILITIES.DOCUMENT_INPUT, 'supported', 'visible-document-attachment', ['file-selection']),
  ...
  route('gemini', TASK_CAPABILITIES.FILE_UPLOAD, 'experimental', 'visible-file-attachment', ['harness-attachment-roundtrip']),
  route('gemini', TASK_CAPABILITIES.DOCUMENT_INPUT, 'experimental', 'visible-document-attachment', ['harness-attachment-roundtrip']),
  ...
  route('grok', TASK_CAPABILITIES.FILE_UPLOAD, 'supported', 'visible-file-attachment', ['file-selection']),
  route('grok', TASK_CAPABILITIES.DOCUMENT_INPUT, 'supported', 'visible-document-attachment', ['file-selection']),
  ...
  route('deepseek', TASK_CAPABILITIES.FILE_UPLOAD, 'experimental', 'visible-file-attachment', ['harness-attachment-roundtrip']),
  route('deepseek', TASK_CAPABILITIES.DOCUMENT_INPUT, 'experimental', 'visible-document-attachment', ['harness-attachment-roundtrip']),
  ...
  route('perplexity', TASK_CAPABILITIES.FILE_UPLOAD, 'experimental', 'visible-file-attachment', ['file-selection']),
  route('perplexity', TASK_CAPABILITIES.DOCUMENT_INPUT, 'experimental', 'visible-document-attachment', ['file-selection']),
  route('qwen', TASK_CAPABILITIES.CONVERSATION_CHAT, 'experimental', 'visible-conversation', ['harness-attachment-roundtrip']),
  route('qwen', TASK_CAPABILITIES.FILE_UPLOAD, 'experimental', 'visible-file-attachment', ['file-selection']),
  route('qwen', TASK_CAPABILITIES.DOCUMENT_INPUT, 'experimental', 'visible-document-attachment', ['harness-attachment-roundtrip']),
  route('zai', TASK_CAPABILITIES.CONVERSATION_CHAT, 'experimental', 'visible-conversation', ['workspace-response-baseline']),
  route('zai', TASK_CAPABILITIES.FILE_UPLOAD, 'experimental', 'visible-file-attachment', ['harness-attachment-roundtrip']),
  route('zai', TASK_CAPABILITIES.DOCUMENT_INPUT, 'experimental', 'visible-document-attachment', ['harness-attachment-roundtrip']),
  route('doubao', TASK_CAPABILITIES.CONVERSATION_CHAT, 'experimental', 'visible-conversation', ['workspace-response-baseline']),
  route('doubao', TASK_CAPABILITIES.FILE_UPLOAD, 'experimental', 'visible-file-attachment', ['harness-attachment-roundtrip']),
  route('doubao', TASK_CAPABILITIES.DOCUMENT_INPUT, 'experimental', 'visible-document-attachment', ['harness-attachment-roundtrip']),
  ...
  route('kimi', TASK_CAPABILITIES.FILE_UPLOAD, 'experimental', 'visible-file-attachment', ['harness-attachment-roundtrip']),
  route('kimi', TASK_CAPABILITIES.DOCUMENT_INPUT, 'experimental', 'visible-document-attachment', ['harness-attachment-roundtrip']),
  ...
  route('github-copilot', TASK_CAPABILITIES.CONVERSATION_CHAT, 'experimental', 'visible-conversation', ['conversation-continuation']),
  route('github-copilot', TASK_CAPABILITIES.WORKSPACE_NATIVE, 'experimental', 'github-repository-context', ['github-copilot-repository']),
  route('github-copilot', TASK_CAPABILITIES.AGENT_EXECUTE, 'experimental', 'github-copilot-cloud-agent', ['github-copilot-agent']),
  route('github-copilot', TASK_CAPABILITIES.SEARCH_WEB, 'experimental', 'github-copilot-agent-retrieval', ['github-copilot-agent']),
  ...
  route('arena', TASK_CAPABILITIES.FILE_UPLOAD, 'experimental', 'arena-image-upload', ['arena-image']),

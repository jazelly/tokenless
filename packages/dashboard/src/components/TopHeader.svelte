...
<header class="top-header" data-testid="top-header">
  <div
    ...
    title={savingsTitle}
  >
    <a href="#system" aria-label={t('manageOutputSavings')}>
  ...
  <a class="top-header-jobs" href="#jobs">
  ...
  <div class="top-header-actions">
    ...
    <a class="top-header-settings" href="#system" aria-label={`${t('system')} · ${t('version')} ${snapshot.daemon.version}`}>

...
const enMessages = {
    ...
    actionRequired: 'Action required', recentJobs: 'Recent jobs', recentConversations: 'recent conversations', moreChats: 'More chats', providerReadiness: 'Provider readiness', noJobs: 'No jobs yet', noJobsBody: 'Conversations will appear here when Tokenless starts work.',
    ...
    providerConfiguration: 'Provider configuration', providersLede: 'Intent, observed access, evidence, and routing eligibility stay separate.', selectProfile: 'Profile', executionMode: 'Execution mode', browserMode: 'Browser', directMode: 'Direct', directOnlyProvider: 'Direct execution only', configured: 'Configured', notSupported: 'Not supported', browserModeHelp: 'Runs through the signed-in provider website.', directModeHelp: 'Connects directly over the provider protocol.', modeUnsupportedHelp: 'This provider does not support this mode.',
    ...
    status: 'Status', version: 'Version', runtime: 'Runtime', ready: 'Ready', stopped: 'Stopped', selected: 'Selected', signedIn: 'Signed in', signedOut: 'Signed out', signInUnknown: 'Sign-in unknown', guestAccess: 'Guest access', freePlan: 'Free plan', paidPlan: 'Paid plan level', planUnknown: 'Plan unknown',
    ...
    selectedBrowser: 'Selected browser', browserVersion: 'Browser version', routerRequirement: 'Engine requirement', routerBrowserModeUnsupported: 'Gemini routing is blocked for this profile browser mode. Select a system Google Chrome profile.', routerBrowserUnsupported: 'The dashboard is not running in Google Chrome. Auto-connect it to Google Chrome to use this engine.', routerBrowserVersionUnsupported: 'Chrome Prompt API requires Google Chrome 148 or newer. Selected version:',
    ...
    routerNeedsEnabledProviders: 'Enable at least one AI provider for this profile before routing.', routerNeedsProviderRules: 'Describe a suitable task for at least one enabled provider.', routerTaskRequired: 'Enter a task prompt.', routerApiUnsupported: 'The selected router engine is not exposed by this Chrome.', routerApiUnavailable: 'The selected router engine is unavailable for this page or device.', routerInvalidResult: 'The selected router engine returned an invalid provider selection.',
    routerTest: 'Semantic router test', routerTestHelp: 'Nano receives only the task and enabled provider rules, including each provider’s currently selected model when known. Disabled providers and operational data are excluded.', taskPrompt: 'Task prompt', taskPromptPlaceholder: 'Draft a product launch announcement with a confident tone.', runSemanticRouter: 'Run semantic router', routerRunning: 'Routing…', routerResult: 'Structured result', startHarnessRun: 'Start Harness run', harnessStarting: 'Starting Harness run…', harnessRun: 'Harness run', harnessProfileRequired: 'Select a managed profile before starting a Harness run.', downloadProgress: 'Model download', downloadZeroHelp: '0% means Chrome accepted the download request but has not reported further model progress. Check Model Status and Event Logs below.',
...
const zhMessages: Record<keyof typeof enMessages, string> = {
    ...
    actionRequired: '需要处理', recentJobs: '最近任务', recentConversations: '个最近对话', moreChats: '更多对话', providerReadiness: 'Provider 就绪状态', noJobs: '还没有任务', noJobsBody: 'Tokenless 开始工作后，对话会显示在这里。',
    ...
    durableJobs: '对话历史', jobsLede: '查看由 Tokenless API 处理的对话。', allStatuses: '全部状态', allProviders: '全部 provider', allProfiles: '全部 profile', searchJobs: '搜索对话…', details: '详情', backToChatHistory: '返回对话历史', conversationDetails: '对话详情', provider: 'Provider', jobId: '任务 ID', messages: '条消息',
    ...
    status: '状态', version: '版本', runtime: '运行时', ready: '就绪', stopped: '已停止', selected: '已选择', signedIn: '已登录', signedOut: '未登录', signInUnknown: '登录状态未知', guestAccess: '访客访问', freePlan: '免费方案', paidPlan: '付费方案级别', planUnknown: '方案未知',
    ...
    selectedBrowser: '所选浏览器', browserVersion: '浏览器版本', routerRequirement: 'Engine 要求', routerBrowserModeUnsupported: '当前 profile 的浏览器模式不能使用 Gemini Router。请选择 system Google Chrome profile。', routerBrowserUnsupported: 'Dashboard 当前不是运行在 Google Chrome 中；请用 auto-connect 连接 Google Chrome 后再使用这个 Engine。', routerBrowserVersionUnsupported: 'Chrome Prompt API 要求 Google Chrome 148 或更高版本。当前版本：',
    ...
    routerNeedsEnabledProviders: '请先为当前 profile 启用至少一个 AI provider。', routerNeedsProviderRules: '请为至少一个已启用的 provider 描述适合的任务。', routerTaskRequired: '请输入任务 prompt。', routerApiUnsupported: '当前 Chrome 没有暴露所选的 Router Engine。', routerApiUnavailable: '当前页面或设备无法使用所选的 Router Engine。', routerInvalidResult: '所选 Router Engine 返回了无效的 provider 选择。',
    routerTest: '语义路由实验', routerTestHelp: 'Nano 只接收任务和已启用的 provider 规则；已知时也会包含该 provider 当前选择的 model。已关闭的 provider 和 operational 数据都不会传入。', taskPrompt: '任务 prompt', taskPromptPlaceholder: '用自信的语气起草一份产品发布公告。', runSemanticRouter: '运行语义路由', routerRunning: '路由中…', routerResult: '结构化结果', startHarnessRun: '启动 Harness run', harnessStarting: '正在启动 Harness run…', harnessRun: 'Harness run', harnessProfileRequired: '请先选择一个 managed profile，再启动 Harness run。', downloadProgress: '模型下载', downloadZeroHelp: '0% 表示 Chrome 已接受下载请求，但尚未报告进一步的模型进度。请查看下方的 Model Status 和 Event Logs。',

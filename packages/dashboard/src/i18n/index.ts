...
const enMessages = {
    ...
    capabilityUsage_7d: 'Capabilities used in the last seven days', capabilityUsage_30d: 'Capabilities used in the last thirty days', capabilityUsage_90d: 'Capabilities used in the last ninety days', capabilityUsage_1y: 'Capabilities used in the last year', capabilityUsage_all: 'Capabilities used so far',
...
const zhMessages: Record<keyof typeof enMessages, string> = {
    ...
    capabilityUsage_7d: '过去七天用了哪些能力', capabilityUsage_30d: '过去三十天用了哪些能力', capabilityUsage_90d: '过去九十天用了哪些能力', capabilityUsage_1y: '过去一年用了哪些能力', capabilityUsage_all: '至今用了哪些能力',
